...
def render_region(path, x0, x1, y0, y1, block=3, thresh=40):
...
f = os.path.join(BASE, "volunteer card.png")
print("===== FRONT (left half) x290-710, y180-1040 =====")
print(render_region(f, 290, 710, 180, 1040, block=3))